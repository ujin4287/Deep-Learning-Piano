...
final_position = [[0 for col in range(finger_num*2)] for row in range(10000)]
...
def start_show_img():
    ...
    while True:
        ...
        left_hand = random.randrange(0, 14)
        ...
        if (finger_left == 0) and (finger_right == 0):
            ...
            data_save(final_position, num_imgs)
...
def video_capture():
    ...
    global start_time, img_counter_gen , num_imgs
    while True:
        # print("video")
        ...
        if time.time() - start_time >= set_time:
            img_name = "./sample/piano_1/{}__{}_{}_{}_{}_{}_{}.png".format(num_imgs, final_position[num_imgs][0], final_position[num_imgs][1],final_position[num_imgs][2],
                                                                   final_position[num_imgs][3],final_position[num_imgs][4],final_position[num_imgs][5],)
...
dir = 'C:/Users/ujin4/PycharmProjects/untitled/sample/piano_1'
...
def data_save(finalposition, num_imgs):
    ...
    for i in finalposition[num_imgs]:
        ws.cell(row = num_imgs+2, column = i+2).value = '1' ################### row 잘못됬으면 바꾸기
    wb.save(filename='./xlsx/PianoData2.xlsx')
